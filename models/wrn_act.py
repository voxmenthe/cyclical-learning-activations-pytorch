...
class WideResNet(nn.Module):
    def __init__(self, depth, num_classes, widen_factor=1, dropRate=0.0, activation=F.relu):
...
def wrn92_2_act(activation=F.relu):
    return WideResNet(depth=100,num_classes=10,widen_factor=2,dropRate=0.5,activation=activation)