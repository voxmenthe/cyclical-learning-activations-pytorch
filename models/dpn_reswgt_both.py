...
__all__ = ['Bottleneck_reswgt_both','DPN_reswgt_both','DPN26_reswgt_both','DPN92_reswgt_both','DPN_X1_reswgt_both']
...
class DPN_reswgt_both(nn.Module):
    def __init__(self, cfg, residual_weight=1.5, activation=F.relu):
        super(DPN_reswgt_both, self).__init__()
    ...
    def _make_layer(self, in_planes, out_planes, num_blocks, dense_depth, stride):
        ...
        for i,stride in enumerate(strides):
            layers.append(Bottleneck_reswgt_both(self.last_planes, in_planes, out_planes, dense_depth, stride, i==0, self.residual_weight))
...
def DPN26_reswgt_both(residual_weight=1.5,activation=F.relu):
    cfg = {
    ...
    return DPN_reswgt_both(cfg)

def DPN92_reswgt_both(residual_weight=1.5,activation=F.relu):
    cfg = {
        'in_planes': (96,192,384,768),
        'out_planes': (256,512,1024,2048),
        'num_blocks': (3,4,20,3),
...
def DPN_X1_reswgt_both(residual_weight=1.5,activation=F.relu):
    cfg = {
